...
{ 
  ...
  public:
	...
	Circular_DLL() //Constructor
	 {
    		tail = NULL;
  	}


	~Circular_DLL() //Destructor
	{
      if(!isEmpty())
    {
	     	temp = tail->next;
...
template <typename T>
void Circular_DLL<T>::insert_at_end()
{
	    newnode = new Node<T>();
    	cout<<"\n Enter the  data: ";
    	cin>>newnode->data;
...
template <typename T>
void Circular_DLL<T>::insert_at_beginning()
{
	    newnode = new Node<T>();
	    cout<<"\n Enter the  data: ";
	    cin>>newnode->data;
...
template <typename T>
void Circular_DLL<T>::insert_in_between()
{
	if (!isEmpty())
	{
    int i=1,loc;
...
template <typename T>
void Circular_DLL<T>::delete_at_end()
{
	    if (!isEmpty())
	   { 
		       if (tail == tail->next)
...
template <typename T>
void Circular_DLL<T>::delete_at_beginning()
{
    	if (!isEmpty())
	   {
		    if (tail->next == tail)
...
template <typename T>
void Circular_DLL<T>::delete_in_between()
{
	if (!isEmpty())
	{
		int i=1,loc;
...
template <typename T>
void Circular_DLL<T>:: delete_data()
{
